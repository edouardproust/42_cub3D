...
C_FILES = debug.c\
	...
	graphics/hooks.c \
	graphics/minimap/init.c \
	graphics/minimap/draw_minimap.c \
	graphics/minimap/player/movement.c \
	graphics/minimap/player/rotation.c \
	graphics/minimap/player/draw.c \
	utils/char.c \
	utils/error.c \
	utils/exit.c \
	utils/free.c \
